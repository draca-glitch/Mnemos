...
def main(argv=None):
    ...
    p = sub.add_parser("consolidate", help="Run dream cycle (requires LLM for phases 1-4)")
    p.add_argument("--execute", action="store_true", help="Apply changes (default: dry run)")
    p.add_argument("--phases", help="Comma-separated phases (e.g., 1,2,5)")
    p.add_argument("--dream", action="store_true", help="Include synthesis phase 4")
