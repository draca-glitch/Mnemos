...
Metadata (FTS, links, dream_insights) is still stored in SQLite; Qdrant
...
class QdrantStore(MnemosStore):
    ...
    def store_dream_insight(self, *args, **kwargs):
        return self._sqlite.store_dream_insight(*args, **kwargs)
